...
kable(segmentedValues(pr)[ sample(1:nrow(segmentedValues(pr)), 10) ,c(1:maxCol)], row.names=F, caption='Example regions of the segmented data.') %>% kable_styling(bootstrap_options=c('striped','condensed',full_width=F, position='left'))
```
