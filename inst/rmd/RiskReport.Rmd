...
pr = predictRisk(loadSampleInformation(clinInfoFile), path=inputPath)
...
```{r risk_sample, fig.height=length(unique(pr$segmented$sample.info$GEJ.Distance)), fig.width=length(levels(pr$segmented$sample.info$Endoscopy))}
printRisk <- function(x,low,high, risk='Unknown') {
  img = switch(risk, 
         'High'='img/Human_body_silhouette-RED.png',
         'Moderate'='img/Human_body_silhouette-YELLOW.png',
